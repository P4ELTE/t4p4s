...
fake_cmd_t t4p4s_testcase_test[][RTE_MAX_LCORE] = SINGLE_LCORE(
    FAST(0, 0, IN(hMISC(op, ENCRYPT)), INOUT(hETH4(ETH01, ETH1A), PAYLOAD(cENCRYPTED1))),
    FAST(0, 0, IN(hMISC(op, ENCRYPT)), INOUT(hETH4(ETH02, ETH1A), PAYLOAD(cENCRYPTED2))),
    FAST(0, 0, IN(hMISC(op, ENCRYPT)), INOUT(hETH4(ETH03, ETH1A), PAYLOAD(cENCRYPTED3))),
    FAST(0, 0, IN(hMISC(op, ENCRYPT)), INOUT(hETH4(ETH04, ETH1A), PAYLOAD(cENCRYPTED4))),
    ...
    FAST(0, 0, IN(hMISC(op, ENCRYPT_THEN_DECRYPT)), hETH4(ETH01, ETH1A)),
    FAST(0, 0, IN(hMISC(op, ENCRYPT_THEN_DECRYPT)), hETH4(ETH02, ETH1A)),
    FAST(0, 0, IN(hMISC(op, ENCRYPT_THEN_DECRYPT)), hETH4(ETH03, ETH1A)),
    FAST(0, 0, IN(hMISC(op, ENCRYPT_THEN_DECRYPT)), hETH4(ETH04, ETH1A))
    );
