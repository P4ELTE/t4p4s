...
PARSER {
    ...
    @name(".parse_ipv4") state parse_ipv4 {
        ...
        hdr.ipv4 = {
            version = ipv4_novarbit.version,
            ihl = ipv4_novarbit.ihl,
            diffserv = ipv4_novarbit.diffserv,
            totalLen = ipv4_novarbit.totalLen,
            identification = ipv4_novarbit.identification,
            flags = ipv4_novarbit.flags,
            fragOffset = ipv4_novarbit.fragOffset,
            ttl = ipv4_novarbit.ttl,
            protocol = ipv4_novarbit.protocol,
            hdrChecksum = ipv4_novarbit.hdrChecksum,
            srcAddr = ipv4_novarbit.srcAddr,
            dstAddr = ipv4_novarbit.dstAddr,
            options = ipv4_varbit.options
        };
