...
control process_mirroring(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_replication(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_vlan_decap(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_tunnel_decap(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
...
control process_rewrite(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_egress_bd(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_egress_qos_map(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_mac_rewrite(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_mtu(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
...
control process_int_insertion(inout headers hdr, inout metadata meta, in psa_egress_input_metadata_t standard_metadata, in psa_egress_output_metadata_t standard_metadata_out) {
...
control process_egress_nat(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_egress_bd_stats(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".egress_bd_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS_AND_BYTES) egress_bd_stats;
    @name(".nop") action nop() {
    }
    ...
    @name(".egress_bd_stats") table egress_bd_stats_0 {
        ...
        size = 1024;
        @name(".egress_bd_stats") counters = egress_bd_stats;
    }
    apply {
...
control process_egress_l4port(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_tunnel_encap(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_egress_acl(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_int_outer_encap(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
...
control process_vlan_xlate(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
...
control process_egress_filter(inout headers hdr, inout metadata meta, inout psa_egress_output_metadata_t standard_metadata) {
...
control process_egress_system_acl(inout headers hdr, inout metadata meta, in psa_egress_input_metadata_t standard_metadata, out psa_egress_output_metadata_t standard_metadata_out) {
    @name(".nop") action nop() {
    }
    @name(".drop_packet") action drop_packet() {
        standard_metadata_out.drop=true;
    }
    @name(".egress_copy_to_cpu") action egress_copy_to_cpu() {
	standard_metadata_out.clone = true;
        standard_metadata_out.clone_session_id = PSA_CLONE_SESSION_TO_CPU;
               ...
               inout psa_egress_output_metadata_t ostd)
{
    ...
    apply {
        if (meta.intrinsic_metadata.deflection_flag == 1w0 && meta.egress_metadata.bypass == 1w0) {
            if (ostd.clone) {
                process_mirroring_0.apply(hdr, meta, ostd);
            }
            else {
                process_replication_0.apply(hdr, meta, ostd);
            }
            switch (egress_port_mapping.apply().action_run) {
                egress_port_type_normal: {
                    if (!ostd.clone) {
                        process_vlan_decap_0.apply(hdr, meta, ostd);
                    }
                    process_tunnel_decap_0.apply(hdr, meta, ostd);
                    process_rewrite_0.apply(hdr, meta, ostd);
                    process_egress_bd_0.apply(hdr, meta, ostd);
                    process_egress_qos_map_0.apply(hdr, meta, ostd);
                    process_mac_rewrite_0.apply(hdr, meta, ostd);
                    process_mtu_0.apply(hdr, meta, ostd);
                    process_int_insertion_0.apply(hdr, meta, istd, ostd);
                    process_egress_nat_0.apply(hdr, meta, ostd);
                    process_egress_bd_stats_0.apply(hdr, meta, ostd);
                }
            }

            process_egress_l4port_0.apply(hdr, meta, ostd);
            process_tunnel_encap_0.apply(hdr, meta, ostd);
            if (meta.egress_metadata.port_type == 2w0) {
                process_egress_acl_0.apply(hdr, meta, ostd);
            }
            process_int_outer_encap_0.apply(hdr, meta, ostd);
            if (meta.egress_metadata.port_type == 2w0) {
                process_vlan_xlate_0.apply(hdr, meta, ostd);
            }
            process_egress_filter_0.apply(hdr, meta, ostd);
        }
        if (meta.egress_metadata.port_type == 2w0) {
            process_egress_system_acl_0.apply(hdr, meta, istd, ostd);
        }
    }
}

control process_ingress_port_mapping(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t standard_metadata) {
    ...
    @name(".set_ingress_port_properties") action set_ingress_port_properties(bit<16> if_label, bit<5> qos_group, bit<5> tc_qos_group, bit<8> tc, PSA_MeterColor_t color, bit<1> trust_dscp, bit<1> trust_pcp) {
...
control validate_outer_ipv4_header(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control validate_outer_ipv6_header(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control validate_mpls_header(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_validate_outer_header(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_global_params(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t standard_metadata, out psa_ingress_output_metadata_t standard_metadata_out) {
    @name(".deflect_on_drop") action deflect_on_drop(bit<1> enable_dod) {
        meta.intrinsic_metadata.deflect_on_drop = enable_dod;
    }
    Random<bit<32>>((bit<32>)32w0, (bit<32>)32w0x7fffffff) rand;
    @name(".set_config_parameters") action set_config_parameters(bit<1> enable_dod) {
        ...
        //standard_metadata_out.egress_spec = 9w511;
        meta.ingress_metadata.sflow_take_sample = rand.read();
    }
...
control process_port_vlan_mapping(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_spanning_tree(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_ingress_qos_map(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".set_ingress_tc") action set_ingress_tc(bit<8> tc) {
        meta.qos_metadata.lkp_tc = tc;
    }
    @name(".set_ingress_color") action set_ingress_color(PSA_MeterColor_t color) {
        meta.meter_metadata.packet_color = color;
    }
    @name(".set_ingress_tc_and_color") action set_ingress_tc_and_color(bit<8> tc, PSA_MeterColor_t color) {
        meta.qos_metadata.lkp_tc = tc;
        meta.meter_metadata.packet_color = color;
    }
...
control process_ip_sourceguard(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_int_endpoint(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    ...
    @name(".int_sink") action int_sink(bit<32> mirror_id) {
        ...
        standard_metadata.clone = true;
        standard_metadata.clone_session_id = PSA_CLONE_SESSION_TO_CPU;
...
control process_ingress_sflow(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".sflow_ingress_session_pkt_counter") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) sflow_ingress_session_pkt_counter;
    @name(".nop") action nop() {
    }
    ...
    @name(".sflow_ingress") table sflow_ingress {
        ...
        size = 512;
        @name(".sflow_ingress_session_pkt_counter") counters = sflow_ingress_session_pkt_counter;
    }
    apply {
        sflow_ingress.apply();
...
control process_ingress_fabric(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_ipv4_vtep(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_ipv6_vtep(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".set_tunnel_termination_flag") action set_tunnel_termination_flag() {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
...
control process_mpls(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_outer_ipv4_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".on_miss") action on_miss() {
    }
...
control process_outer_ipv6_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".on_miss") action on_miss() {
    }
...
control process_outer_multicast_rpf(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    apply {
    }
}

control process_outer_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_tunnel(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_storm_control(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t standard_metadata) {
    @name(".storm_control_meter") Meter<bit<32>>(32w1024, PSA_MeterType_t.BYTES) storm_control_meter;
    @name(".nop") action nop() {
    }
    @name(".set_storm_control_meter") action set_storm_control_meter(bit<32> meter_idx) {
        storm_control_meter.execute((bit<32>)meter_idx, meta.meter_metadata.packet_color);
...
control process_validate_packet(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_ingress_l4port(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_mac(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_mac_acl(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".acl_deny") action acl_deny(bit<14> acl_stats_index, bit<16> acl_meter_index, bit<16> acl_copy_reason, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.acl_deny = 1w1;
    ...
    @name(".acl_permit") action acl_permit(bit<14> acl_stats_index, bit<16> acl_meter_index, bit<16> acl_copy_reason, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.acl_stats_index = acl_stats_index;
        meta.meter_metadata.meter_index = acl_meter_index;
        meta.fabric_metadata.reason_code = acl_copy_reason;
        meta.nat_metadata.ingress_nat_mode = nat_mode;
    ...
    @name(".acl_redirect_nexthop") action acl_redirect_nexthop(bit<16> nexthop_index, bit<14> acl_stats_index, bit<16> acl_meter_index, bit<16> acl_copy_reason, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
    ...
    @name(".acl_redirect_ecmp") action acl_redirect_ecmp(bit<16> ecmp_index, bit<14> acl_stats_index, bit<16> acl_meter_index, bit<16> acl_copy_reason, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.acl_redirect = 1w1;
    ...
    @name(".acl_mirror") action acl_mirror(bit<32> session_id, bit<14> acl_stats_index, bit<16> acl_meter_index, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.i2e_metadata.mirror_session_id = (bit<16>)session_id;
        standard_metadata.clone = true;
        standard_metadata.clone_session_id = PSA_CLONE_SESSION_TO_CPU;
...
control process_ip_acl(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".acl_deny") action acl_deny(bit<14> acl_stats_index, bit<16> acl_meter_index, bit<16> acl_copy_reason, bit<2> nat_mode, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.acl_deny = 1w1;
...
control process_ipv4_racl(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".racl_deny") action racl_deny(bit<14> acl_stats_index, bit<16> acl_copy_reason, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
    ...
    @name(".racl_permit") action racl_permit(bit<14> acl_stats_index, bit<16> acl_copy_reason, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.acl_stats_index = acl_stats_index;
        meta.fabric_metadata.reason_code = acl_copy_reason;
        meta.intrinsic_metadata.ingress_cos = ingress_cos;
        meta.qos_metadata.lkp_tc = tc;
    ...
    @name(".racl_redirect_nexthop") action racl_redirect_nexthop(bit<16> nexthop_index, bit<14> acl_stats_index, bit<16> acl_copy_reason, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
    ...
    @name(".racl_redirect_ecmp") action racl_redirect_ecmp(bit<16> ecmp_index, bit<14> acl_stats_index, bit<16> acl_copy_reason, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.racl_redirect = 1w1;
...
control process_ipv4_urpf(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".on_miss") action on_miss() {
    }
...
control process_ipv4_fib(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".on_miss") action on_miss() {
    }
...
control process_ipv6_racl(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    @name(".racl_deny") action racl_deny(bit<14> acl_stats_index, bit<16> acl_copy_reason, bit<3> ingress_cos, bit<8> tc, PSA_MeterColor_t color) {
        meta.acl_metadata.racl_deny = 1w1;
...
control process_ipv6_urpf(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".on_miss") action on_miss() {
    }
...
control process_ipv6_fib(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".on_miss") action on_miss() {
    }
    @name(".fib_hit_nexthop") action fib_hit_nexthop(bit<16> nexthop_index) {
        meta.l3_metadata.fib_hit = 1w1;
...
control process_urpf_bd(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_ipv4_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".ipv4_multicast_route_s_g_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) ipv4_multicast_route_s_g_stats;
    @name(".ipv4_multicast_route_star_g_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) ipv4_multicast_route_star_g_stats;
    @name(".on_miss") action on_miss() {
    }
    ...
    @name(".ipv4_multicast_route") table ipv4_multicast_route {
        ...
        size = 1024;
        @name(".ipv4_multicast_route_s_g_stats") counters = ipv4_multicast_route_s_g_stats;
    }
    ...
    @name(".ipv4_multicast_route_star_g") table ipv4_multicast_route_star_g {
        ...
        size = 1024;
        @name(".ipv4_multicast_route_star_g_stats") counters = ipv4_multicast_route_star_g_stats;
    }
    apply {
        if ((meta.ingress_metadata.bypass_lookups & 16w0x1) == 16w0) {
...
control process_ipv6_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".ipv6_multicast_route_s_g_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) ipv6_multicast_route_s_g_stats;
    @name(".ipv6_multicast_route_star_g_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) ipv6_multicast_route_star_g_stats;
    @name(".on_miss") action on_miss() {
    }
    @name(".multicast_bridge_s_g_hit") action multicast_bridge_s_g_hit(bit<16> mc_index) {
        meta.multicast_metadata.multicast_bridge_mc_index = mc_index;
    ...
    @name(".ipv6_multicast_route") table ipv6_multicast_route {
        ...
        size = 1024;
        @name(".ipv6_multicast_route_s_g_stats") counters = ipv6_multicast_route_s_g_stats;
    }
    ...
    @name(".ipv6_multicast_route_star_g") table ipv6_multicast_route_star_g {
        ...
        size = 1024;
        @name(".ipv6_multicast_route_star_g_stats") counters = ipv6_multicast_route_star_g_stats;
    }
    apply {
        if ((meta.ingress_metadata.bypass_lookups & 16w0x1) == 16w0) {
...
control process_multicast_rpf(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    apply {
    }
}

control process_multicast(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
...
control process_ingress_nat(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".on_miss") action on_miss() {
    }
...
control process_meter_index(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".meter_index") DirectMeter(PSA_MeterType_t.BYTES) meter_index;
    @name(".nop") action nop() {
    }
    @name(".nop") action nop_2() {
        meter_index.execute(meta.meter_metadata.packet_color);
    }
...
control process_hashes(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    Hash<bit<16>>(PSA_HashAlgorithm_t.CRC16) crc16;
    @name(".compute_lkp_ipv4_hash") action compute_lkp_ipv4_hash() {
        meta.hash_metadata.hash1 = crc16.get_hash((bit<32>)0, { meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);
        /*hash(meta.hash_metadata.hash1, PSA_HashAlgorithm_t.crc16, (bit<16>)0, { meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);*/
        meta.hash_metadata.hash2 = crc16.get_hash((bit<32>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);
        /*hash(meta.hash_metadata.hash2, PSA_HashAlgorithm_t.crc16, (bit<16>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);*/
    }
    @name(".compute_lkp_ipv6_hash") action compute_lkp_ipv6_hash() {
        meta.hash_metadata.hash1 = crc16.get_hash((bit<32>)0, { meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);
        /*hash(meta.hash_metadata.hash1, PSA_HashAlgorithm_t.crc16, (bit<16>)0, { meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);*/
        meta.hash_metadata.hash2 = crc16.get_hash((bit<32>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);
        /*hash(meta.hash_metadata.hash2, PSA_HashAlgorithm_t.crc16, (bit<16>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)65536);*/
    }
    @name(".compute_lkp_non_ip_hash") action compute_lkp_non_ip_hash() {
        meta.hash_metadata.hash2 = crc16.get_hash((bit<32>)0, { meta.ingress_metadata.ifindex, meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.l2_metadata.lkp_mac_type }, (bit<32>)65536);
        /*hash(meta.hash_metadata.hash2, PSA_HashAlgorithm_t.crc16, (bit<16>)0, { meta.ingress_metadata.ifindex, meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.l2_metadata.lkp_mac_type }, (bit<32>)65536);*/
    }
...
control process_meter_action(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".meter_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) meter_stats;
    ...
    @name(".meter_action") table meter_action {
        ...
        size = 1024;
        @name(".meter_stats") counters = meter_stats;
    }
    apply {
        if ((meta.ingress_metadata.bypass_lookups & 16w0x10) == 16w0) {
            meter_action.apply();
...
control process_ingress_bd_stats(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".ingress_bd_stats") @min_width(32) Counter<PacketCounter_t, bit<32>>(32w1024, PSA_CounterType_t.PACKETS_AND_BYTES) ingress_bd_stats;
...
control process_ingress_acl_stats(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".acl_stats") @min_width(16) Counter<PacketCounter_t, bit<32>>(32w1024, PSA_CounterType_t.PACKETS_AND_BYTES) acl_stats;
...
control process_storm_control_stats(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t standard_metadata) {
    @name(".storm_control_stats") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) storm_control_stats;
    @name(".nop") action nop() {
    }
    ...
    @name(".storm_control_stats") table storm_control_stats_0 {
        ...
        size = 1024;
        @name(".storm_control_stats") counters = storm_control_stats;
    }
    apply {
...
control process_fwd_results(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t standard_metadata, out psa_ingress_output_metadata_t standard_metadata_out) {
    @name(".nop") action nop() {
    }
    ...
    @name(".set_cpu_redirect_action") action set_cpu_redirect_action() {
        ...
        meta.intrinsic_metadata.mcast_grp = 16w0;
        //standard_metadata_out.egress_spec = 9w64;
        meta.ingress_metadata.egress_ifindex = 16w0;
        meta.fabric_metadata.dst_device = 8w0;
    }
...
control process_nexthop(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    ...
    @name(".ecmp_group") table ecmp_group {
        ...
        size = 1024;
        @name(".ecmp_action_profile") @mode("fair") implementation = ActionSelector(PSA_HashAlgorithm_t.IDENTITY, 32w1024, 32w10);
    }
...
control process_multicast_flooding(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_lag(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    ...
    @name(".lag_group") table lag_group {
        ...
        size = 1024;
        @name(".lag_action_profile") @mode("fair") implementation = ActionSelector(PSA_HashAlgorithm_t.IDENTITY, 32w1024, 32w8);
    }
    apply {
        lag_group.apply();
    }
...
@name("mac_learn_digest") struct mac_learn_digest_t {
    bit<16> bd;
    bit<48> lkp_mac_sa;
    bit<16> ifindex;
}

control process_mac_learning(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    Digest<mac_learn_digest_t>() mac_learn_digest;
    @name(".generate_learn_notify") action generate_learn_notify() {
        mac_learn_digest.pack({ meta.ingress_metadata.bd, meta.l2_metadata.lkp_mac_sa, meta.ingress_metadata.ifindex });
    }
...
control process_fabric_lag(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
    ...
    @name(".fabric_lag") table fabric_lag {
        ...
        @name(".fabric_lag_action_profile") @mode("fair") implementation = ActionSelector(PSA_HashAlgorithm_t.IDENTITY, 32w1024, 32w8);
    }
    apply {
        fabric_lag.apply();
    }
...
control process_traffic_class(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".nop") action nop() {
    }
...
control process_system_acl(inout headers hdr, inout metadata meta, inout psa_ingress_output_metadata_t standard_metadata) {
    @name(".drop_stats") Counter<PacketCounter_t, bit<32>>(32w1024, PSA_CounterType_t.PACKETS) drop_stats;
    @name(".drop_stats_2") Counter<PacketCounter_t, bit<32>>(32w1024, PSA_CounterType_t.PACKETS) drop_stats_2;
    @name(".copp") Meter<bit<32>>(32w128, PSA_MeterType_t.BYTES) copp;
    ...
    @name(".copy_to_cpu") action copy_to_cpu(bit<5> qid, bit<32> meter_id, bit<3> icos) {
        ...
        copp.execute((bit<32>)meter_id, meta.intrinsic_metadata.packet_color);
    }
                ...
                inout psa_ingress_output_metadata_t ostd)
{
    ...
    apply {
        process_ingress_port_mapping_0.apply(hdr, meta, istd);
        process_validate_outer_header_0.apply(hdr, meta, ostd);
        process_global_params_0.apply(hdr, meta, istd, ostd);
        process_port_vlan_mapping_0.apply(hdr, meta, ostd);
        process_spanning_tree_0.apply(hdr, meta, ostd);
        process_ingress_qos_map_0.apply(hdr, meta, ostd);
        process_ip_sourceguard_0.apply(hdr, meta, ostd);
        process_int_endpoint_0.apply(hdr, meta, ostd);
        process_ingress_sflow_0.apply(hdr, meta, ostd);
        process_tunnel_0.apply(hdr, meta, ostd);
        process_storm_control_0.apply(hdr, meta, istd);
        if (meta.ingress_metadata.port_type != 2w1) {
            if (!(hdr.mpls[0].isValid() && meta.l3_metadata.fib_hit == 1w1)) {
                process_validate_packet_0.apply(hdr, meta, ostd);
                process_ingress_l4port_0.apply(hdr, meta, ostd);
                process_mac_0.apply(hdr, meta, ostd);
                if (meta.l3_metadata.lkp_ip_type == 2w0) {
                    process_mac_acl_0.apply(hdr, meta, ostd);
                }
                else {
                    ...
                    default: {
                        if ((meta.ingress_metadata.bypass_lookups & 16w0x2) == 16w0) {
                            if (meta.l3_metadata.lkp_ip_type == 2w1 && meta.ipv4_metadata.ipv4_unicast_enabled == 1w1) {
                                process_ipv4_racl_0.apply(hdr, meta, ostd);
                                process_ipv4_urpf_0.apply(hdr, meta, ostd);
                                process_ipv4_fib_0.apply(hdr, meta, ostd);
                            }
                            else {
                                if (meta.l3_metadata.lkp_ip_type == 2w2 && meta.ipv6_metadata.ipv6_unicast_enabled == 1w1) {
                                    process_ipv6_racl_0.apply(hdr, meta, ostd);
                                    process_ipv6_urpf_0.apply(hdr, meta, ostd);
                                    process_ipv6_fib_0.apply(hdr, meta, ostd);
                                }
                            }
                ...
                process_ingress_nat_0.apply(hdr, meta, ostd);
            }
        }
        process_meter_index_0.apply(hdr, meta, ostd);
        process_hashes_0.apply(hdr, meta, ostd);
        process_meter_action_0.apply(hdr, meta, ostd);
        if (meta.ingress_metadata.port_type != 2w1) {
            process_ingress_bd_stats_0.apply(hdr, meta, ostd);
            process_ingress_acl_stats_0.apply(hdr, meta, ostd);
            process_storm_control_stats_0.apply(hdr, meta, istd);
            process_fwd_results_0.apply(hdr, meta, istd, ostd);
            process_nexthop_0.apply(hdr, meta, ostd);
            if (meta.ingress_metadata.egress_ifindex == 16w65535) {
                process_multicast_flooding_0.apply(hdr, meta, ostd);
            }
            else {
                process_lag_0.apply(hdr, meta, ostd);
            }
            process_mac_learning_0.apply(hdr, meta, ostd);
        }
        process_fabric_lag_0.apply(hdr, meta, ostd);
        process_traffic_class_0.apply(hdr, meta, ostd);
        if (meta.ingress_metadata.port_type != 2w1) {
            process_system_acl_0.apply(hdr, meta, ostd);
        }
    }
}
