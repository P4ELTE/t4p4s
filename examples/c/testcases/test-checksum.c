...
fake_cmd_t t4p4s_testcase_test[][RTE_MAX_LCORE] = {
    {
        ...
        FAST(0, 123, hETH4(ETH01, ETH02), IP4_01, IP4_01_OPTS, TCP01, TCP01_OPTS, PAYLOAD01),
        
        FAST(0, 0, hETH4(ETH01, ETH02), IP4_02, IP4_02_OPTS, PAYLOAD02),
        
        FAST(0, 0, hETH4(ETH01, ETH02), IP4_03, IP4_03_OPTS, PAYLOAD03),
        
        FAST(0, 123, hETH4(ETH01, ETH02), IP4_04, IP4_04_OPTS, TCP04, TCP04_OPTS, PAYLOAD04), 
