...
for table, table_info in table_infos:
    ...
    #{     #ifdef T4P4S_STATS
    #[         t4p4s_stats_global.T4STAT(table,apply,${table.name}) = true;
    #[         t4p4s_stats_per_packet.T4STAT(table,apply,${table.name}) = true;
    ...
    for stat_action in table.actions:
        ...
        #[             t4p4s_stats_global.T4STAT(action,${table.name},${stat_action_name}) = true;
        #[             t4p4s_stats_per_packet.T4STAT(action,${table.name},${stat_action_name}) = true;
        #}         }
    #}     #endif
    #} }
    #[
